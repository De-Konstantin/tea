(() => {
    ...
    function initSliders() {
        if (document.querySelector(".swiper")) {
            const thumbsSwiper = new core(".puer-swiper-thumb", {
                modules: [ Navigation, Grid, Thumb, Pagination ],
                observer: true,
                observeParents: true,
                slidesPerView: 2,
                freeMode: true,
            ...
            new core(".puer-swiper", {
                modules: [ Navigation, Grid, Thumb ],
                observer: true,
                observeParents: true,
                spaceBetween: 5,
                speed: 800,
            ...
            const thumbsSwiper2 = new core(".fruit-swiper-thumb", {
                modules: [ Navigation, Grid, Thumb, Pagination ],
                observer: true,
                observeParents: true,
                slidesPerView: 2,
            ...
            const thumbsSwiper3 = new core(".oolong-swiper-thumb", {
                modules: [ Navigation, Grid, Thumb, Pagination ],
                observer: true,
                observeParents: true,
                slidesPerView: 2,
            ...
            const thumbsSwiper4 = new core(".exclusive-swiper-thumb", {
                modules: [ Navigation, Grid, Thumb, Pagination ],
                observer: true,
                observeParents: true,
                slidesPerView: 2,
